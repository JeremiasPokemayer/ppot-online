...
class InitResultP2 extends HTMLElement {
  connectedCallback() {
    this.render();
  }
  render() {
    let variantEl = state.data.currentGame.player2.result;
    console.log(variantEl, "variantEl P2");
...
customElements.define("result-page-p2", InitResultP2);
